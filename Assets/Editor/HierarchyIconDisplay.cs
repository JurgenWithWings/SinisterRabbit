...
public static class HierarchyIconDisplay {
    ...
    private static void OnEditorUpdate() {
        ...
        if (type != null) {
            ...
            hierarchyEditorWindow = (objs != null && objs.Length > 0) ? objs[0] as EditorWindow : null;
        } else {
            hierarchyEditorWindow = null;
        }
    ...
    private static void OnHierarchyWindowItemOnGUI(int instanceID, Rect selectionRect) {
        ...
        bool onlyOneComponent = !(components.Length > 1);
        ...
        // Show Folder Icon for empty GameObjects
        GUIContent content;
        if (onlyOneComponent && go.name.StartsWith("f:")) {
            content = EditorGUIUtility.IconContent("Folder Icon");
            content.text = null;
            content.tooltip = "Folder";
        }
        else {
